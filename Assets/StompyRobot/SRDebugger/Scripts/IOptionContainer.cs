...
namespace SRDebugger {
    ...
    ///   Options that are added or removed after this point must fire the <see cref="OptionAdded" /> and
    ///   <see cref="OptionRemoved" /> events in order
    ///   for those options to be added/removed from the debug panel.
    ///   If you do not intend to fire any events (i.e. this is a static container) then <see cref="IsDynamic" /> should return
    ///   false.
    /// </remarks>
    public interface IOptionContainer {
        ...
        ///   If true, changes to the option set can be provided via the events <see cref="OptionAdded" /> and
        ///   <see cref="OptionRemoved" />.
