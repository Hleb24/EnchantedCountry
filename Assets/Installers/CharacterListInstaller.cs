...
namespace Aberrance.Installers {
  ...
  public class CharacterListInstaller : MonoInstaller {
    public override void InstallBindings() {
      ...
      // Container.Bind<IEquipmentUsed>().FromResolveGetter(Dealers.ResolveClone<IEquipmentUsed>()).AsTransient();
      Container.Bind<IEquipmentUsed>().FromResolveGetter(Dealers.ResolveCloneWithTracking<IEquipmentUsed>()).AsTransient();
